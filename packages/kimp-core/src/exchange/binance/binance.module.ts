...
import { SimulationExchangeService } from '../simulation/simulation-exchange.service';
import { SimulationModule } from '../simulation/simulation.module'; // ⭐️ SimulationModule import 추가
